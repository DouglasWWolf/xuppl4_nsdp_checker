...
module datapath_checker_imp_17S0UTF
  ...
  wire pcie_axi_aclk;
  wire [8:0]reporter_0_error;
  wire [511:0]reporter_0_error_data;
  wire reporter_0_eth_active;
  wire [31:0]reporter_0_expected_frame_pattern;
  wire reporter_1_chan_ok;
  wire [8:0]reporter_1_error;
  wire [511:0]reporter_1_error_data;
  wire reporter_1_eth_active;
  wire [31:0]reporter_1_expected_frame_pattern;
  ...
  assign ch1_ok = reporter_1_chan_ok;
  assign eth0_rx_TDATA = eth0_rx_tdata[511:0];
  assign eth0_rx_TKEEP = eth0_rx_tkeep[63:0];
  assign eth0_rx_TLAST = eth0_rx_tlast;
  assign eth0_rx_TVALID = eth0_rx_tvalid;
  assign eth0_rx_tready = eth0_rx_TREADY;
  assign eth1_rx_TDATA = eth1_rx_tdata[511:0];
  assign eth1_rx_TKEEP = eth1_rx_tkeep[63:0];
  assign eth1_rx_TLAST = eth1_rx_tlast;
  assign eth1_rx_TVALID = eth1_rx_tvalid;
  assign eth1_rx_tready = eth1_rx_TREADY;
  ...
  top_level_axi_reporter_0_0 axi_reporter
       (.S_AXI_ARADDR({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,S_AXI_ER_1_ARADDR}),
        ...
        .ch0_error(reporter_0_error),
        .ch0_error_data(reporter_0_error_data),
        .ch0_eth_active(reporter_0_eth_active),
        .ch0_expected_fdata(reporter_0_expected_frame_pattern),
        .ch0_status(ch0_ok),
        .ch1_error(reporter_1_error),
        .ch1_error_data(reporter_1_error_data),
        .ch1_eth_active(reporter_1_eth_active),
        .ch1_expected_fdata(reporter_1_expected_frame_pattern),
        .ch1_status(reporter_1_chan_ok),
        .clk(pcie_axi_aclk),
  ...
  reporter_0_imp_14RIEO2 reporter_0
       (.FRAME_SIZE(mindy_core_ctl_0_FRAME_SIZE),
        ...
        .chan_ok(ch0_ok),
        .clk(pcie_axi_aclk),
        .error(reporter_0_error),
        .error_data(reporter_0_error_data),
        .eth_active(reporter_0_eth_active),
        .eth_rx_tdata(eth0_rx_TDATA),
        .eth_rx_tkeep(eth0_rx_TKEEP),
        .eth_rx_tlast(eth0_rx_TLAST),
        .eth_rx_tready(eth0_rx_TREADY),
        .eth_rx_tvalid(eth0_rx_TVALID),
        .expected_frame_pattern(reporter_0_expected_frame_pattern),
  ...
  reporter_1_imp_YQ6NLO reporter_1
       (.FRAME_SIZE(mindy_core_ctl_0_FRAME_SIZE),
        ...
        .chan_ok(reporter_1_chan_ok),
        .clk(pcie_axi_aclk),
        .error(reporter_1_error),
        .error_data(reporter_1_error_data),
        .eth_active(reporter_1_eth_active),
        .eth_rx_tdata(eth1_rx_TDATA),
        .eth_rx_tkeep(eth1_rx_TKEEP),
        .eth_rx_tlast(eth1_rx_TLAST),
        .eth_rx_tready(eth1_rx_TREADY),
        .eth_rx_tvalid(eth1_rx_TVALID),
        .expected_frame_pattern(reporter_1_expected_frame_pattern),
        .sys_resetn(checker_ctl_sys_resetn_out));
endmodule
...
module reporter_0_imp_14RIEO2
  ...
  input eth_rx_tvalid;
  output [31:0]expected_frame_pattern;
  input sys_resetn;
  ...
  (* CONN_BUS_INFO = "ila0_eth_rx xilinx.com:interface:axis:1.0 None TDATA" *) (* DONT_TOUCH *) wire [511:0]ila0_eth_rx_TDATA;
  (* CONN_BUS_INFO = "ila0_eth_rx xilinx.com:interface:axis:1.0 None TKEEP" *) (* DONT_TOUCH *) wire [63:0]ila0_eth_rx_TKEEP;
  (* CONN_BUS_INFO = "ila0_eth_rx xilinx.com:interface:axis:1.0 None TLAST" *) (* DONT_TOUCH *) wire ila0_eth_rx_TLAST;
  (* CONN_BUS_INFO = "ila0_eth_rx xilinx.com:interface:axis:1.0 None TREADY" *) (* DONT_TOUCH *) wire ila0_eth_rx_TREADY;
  (* CONN_BUS_INFO = "ila0_eth_rx xilinx.com:interface:axis:1.0 None TVALID" *) (* DONT_TOUCH *) wire ila0_eth_rx_TVALID;
  ...
  assign error[8:0] = ila0_error;
  assign error_data[511:0] = ila0_error_data;
  assign eth_active = data_checker_eth_active;
  assign eth_rx_tready = ila0_eth_rx_TREADY;
  assign expected_frame_pattern[31:0] = ila0_expected_frame_pattern;
  assign ila0_eth_rx_TDATA = eth_rx_tdata[511:0];
  assign ila0_eth_rx_TKEEP = eth_rx_tkeep[63:0];
  ...
  top_level_system_ila_0_3 reporter_ila
       (.SLOT_0_AXIS_tdata(ila0_eth_rx_TDATA[0]),
        .SLOT_0_AXIS_tdest(1'b0),
        .SLOT_0_AXIS_tid(1'b0),
        .SLOT_0_AXIS_tkeep(ila0_eth_rx_TKEEP[0]),
        .SLOT_0_AXIS_tlast(ila0_eth_rx_TLAST),
        .SLOT_0_AXIS_tready(ila0_eth_rx_TREADY),
        .SLOT_0_AXIS_tstrb(1'b1),
        .SLOT_0_AXIS_tuser(1'b0),
        .SLOT_0_AXIS_tvalid(ila0_eth_rx_TVALID),
        .clk(pcie_axi_aclk),
        .probe0(ila0_all_good),
        .probe1(ila0_error[0]),
        .probe2(ila0_expected_frame_pattern[0]),
        .probe3(ila0_error_data[0]),
        .resetn(1'b0));
endmodule
...
module reporter_1_imp_YQ6NLO
  ...
  (* CONN_BUS_INFO = "ila1_eth_rx xilinx.com:interface:axis:1.0 None TDATA" *) (* DONT_TOUCH *) wire [511:0]ila1_eth_rx_TDATA;
  (* CONN_BUS_INFO = "ila1_eth_rx xilinx.com:interface:axis:1.0 None TKEEP" *) (* DONT_TOUCH *) wire [63:0]ila1_eth_rx_TKEEP;
  (* CONN_BUS_INFO = "ila1_eth_rx xilinx.com:interface:axis:1.0 None TLAST" *) (* DONT_TOUCH *) wire ila1_eth_rx_TLAST;
  (* CONN_BUS_INFO = "ila1_eth_rx xilinx.com:interface:axis:1.0 None TREADY" *) (* DONT_TOUCH *) wire ila1_eth_rx_TREADY;
  (* CONN_BUS_INFO = "ila1_eth_rx xilinx.com:interface:axis:1.0 None TVALID" *) (* DONT_TOUCH *) wire ila1_eth_rx_TVALID;
  ...
  assign checker_ctl_sys_resetn_out = sys_resetn;
  assign error[8:0] = ila1_error;
  assign error_data[511:0] = ila1_error_data;
  assign eth_active = data_checker_eth_active;
  assign eth_rx_tready = ila1_eth_rx_TREADY;
  assign expected_frame_pattern[31:0] = ila1_expected_frame_pattern;
  assign ila1_eth_rx_TDATA = eth_rx_tdata[511:0];
  assign ila1_eth_rx_TKEEP = eth_rx_tkeep[63:0];
  ...
  top_level_pattern_fifo_0 pattern_fifo
       (.m_axis_tdata(ch1_axis_pattern_TDATA),
        ...
        .s_axis_tready(axis_in0_1_TREADY),
        .s_axis_tvalid(axis_in0_1_TVALID));
  top_level_reporter_ila_0 reporter_ila
       (.SLOT_0_AXIS_tdata(ila1_eth_rx_TDATA[0]),
        .SLOT_0_AXIS_tdest(1'b0),
        .SLOT_0_AXIS_tid(1'b0),
        .SLOT_0_AXIS_tkeep(ila1_eth_rx_TKEEP[0]),
        .SLOT_0_AXIS_tlast(ila1_eth_rx_TLAST),
        .SLOT_0_AXIS_tready(ila1_eth_rx_TREADY),
        .SLOT_0_AXIS_tstrb(1'b1),
        .SLOT_0_AXIS_tuser(1'b0),
        .SLOT_0_AXIS_tvalid(ila1_eth_rx_TVALID),
        .clk(pcie_axi_aclk),
        .probe0(ila1_all_good),
        .probe1(ila1_error[0]),
        .probe2(ila1_expected_frame_pattern[0]),
        .probe3(ila1_error_data[0]),
        .resetn(1'b0));
endmodule

(* CORE_GENERATION_INFO = "top_level,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_level,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=42,numReposBlks=33,numNonXlnxBlks=0,numHierBlks=9,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=14,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "top_level.hwdef" *) 
module top_level
   (init_clk,
    led_green_l,
    led_orange_l,
